...
_C.MODEL.COOR_ATTRIBUTE = False
_C.MODEL.COOR_UNCERN = False
_C.MODEL.GRM_ATTRIBUTE = False
_C.MODEL.GRM_UNCERN = False
...
# The normalization type of backbone
_C.MODEL.BACKBONE.NORM_TYPE = "BN"
...
_C.MODEL.HEAD.SOFTGRM_LOSS_WEIGHT = []
...
# Ramp up the loss weight for some big loss.
_C.SOLVER.RAMPUP_ITERATIONS = 0
...
_C.SOLVER.DYNAMIC_WEIGHT = False
_C.SOLVER.DYNAMIC_THRESHOLD = 0.0
...
_C.TEST.UNCERTAINTY_GUIDED_PRUNING = True
_C.TEST.UNCERTAINTY_GUIDED_PARAM = 3
_C.TEST.UNCERTAINTY_3D = "GRM_uncern"

_C.TEST.METRIC = ['R40']
_C.TEST.EVAL_DIS_IOUS = False
_C.TEST.EVAL_DEPTH = False
_C.TEST.SURVEY_DEPTH = False
...
_C.TEST.DETECTIONS_3D_THRESHOLD = 0.0
_C.TEST.VISUALIZE_THRESHOLD = 0.0

_C.TEST.USE_NMS = False
