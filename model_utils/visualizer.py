...
from structures import Boxes, BoxMode, Keypoints
...
class _PanopticPrediction:
    def __init__(self, panoptic_seg, segments_info):
        ...
        segment_ids, areas = ops.Unique()(panoptic_seg)
        areas = areas.numpy()
...
class Visualizer:
    ...
    def __init__(self, img_rgb, metadata=None, scale=1.0, instance_mode=ColorMode.IMAGE):
        ...
        self.cpu_device = ms.get_context("device_target")
    ...
    def _convert_boxes(self, boxes):
        ...
        if isinstance(boxes, Boxes) or isinstance(boxes):
